...
const leftHandKeys = ["q"];
const rightHandKeys = ["p"];

// Generates practice streams containing ONLY 'q', 'p', and spaces
const generateWordParagraph = () => {
  const templates = [
    "q p q p q p p q q p q p q q p q p q p p q q p q p p q p q p q",
    "p q p q p p q q p q p q p p q q p q p q p q q p p q p q p p q",
    "q q p p q p q p p q q p q q p p q p q p p q q p q p q p p q q",
    "p p q q p q p q q p p q p p q q p q p q q p p q p q p q q p p",
    "q p p q q p p q q p p q q p p q q p p q q p p q q p q p p q q",
    "p q q p p q q p p q q p p q q p p q q p p q q p p q p q q p p"
  ];
...
export default function Lesson10_1() {
  ...
  const handleKeyDown = (e) => {
    if (showPopup) {
      if (e.key === " ") {
        e.preventDefault();
        // Route to the next logical lesson
        navigate("/lesson10/10.2");
      }
      return;
    }
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl font-extrabold tracking-wide text-center w-full max-w-[1440px] mx-auto mb-12">
        Isolated Finger Drill (Q and P Keys)
      </h1>
      ...
      <div className="w-full max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-[200px_1fr_420px] gap-10 items-start">
          ...
          <div className="bg-[#111827] border border-[#2b3245] border-l-[10px] border-l-purple-500 rounded-2xl px-10 py-8 shadow-2xl flex flex-col w-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-extrabold tracking-wide text-purple-400">
                Fingering Guide for Q & P
              </h2>
            </div>
            <p className="text-md leading-relaxed text-gray-300 font-medium">
              Stretch your <span className="text-amber-400 font-bold">Left Pinky Finger</span> up and slightly left from <span className="underline">A</span> to hit <span className="text-amber-400 font-bold">Q</span>. Stretch your <span className="text-[#00E676] font-bold">Right Pinky Finger</span> up and slightly right from <span className="underline">;</span> to hit <span className="text-[#00E676] font-bold">P</span>. Keep your wrists hovering naturally and avoid twisting your hands.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="bg-[#111827] border border-[#2b3245] rounded-3xl p-8 shadow-xl flex flex-col items-center text-center justify-center min-h-[180px]">
            ...
            <h3 className={`text-6xl font-black font-mono ${nextTargetChar === " " ? "text-gray-500" : nextTargetChar === "q" ? "text-amber-400" : "text-[#00E676]"}`}>
        ...
        <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 backdrop-blur-md p-4">
          <div className="bg-[#02040f] border-2 border-[#2b3245] rounded-[48px] p-16 flex flex-col items-center shadow-2xl text-center max-w-[640px] w-full mx-auto transition-all">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-[500px]">
              <button
                onClick={() => navigate("/lesson10/10.2")}
