...
// Image Assets
import lessonKeyboard from "../../assets/lesson7.1.png";

// Hand territories for tracking targets
const leftHandKeys = ["g"];
const rightHandKeys = ["h"];

// Generates practice streams containing ONLY 'g', 'h', and spaces (No commas)
const generateWordParagraph = () => {
  const templates = [
    "g h g h g h h g g h g h g g h g h g h h g g h g h h g h g h g",
    "h h g g h g h g h g h g g h g h g h g h g h h g g h g h g g h",
    "g h g h g g h g h g h h g h g h g h h g h g h g h g h g h g g",
    "g h g g h h g g h g h h g h g h g h g h g h g g h h g g h h g",
    "h g h g h h g g h h g h g h g g h g h h g h g h g h g g h h g"
  ];
  ...
  const handleKeyDown = (e) => {
    ...
    if (key.length === 1 || key === " ") {
      ...
      if (isCorrect) {
        ...
        if (expectedChar === "g") {
          displayInstruction = "STRETCH LEFT INDEX FINGER RIGHTWARD FOR G";
        } else if (expectedChar === "h") {
          displayInstruction = "STRETCH RIGHT INDEX FINGER LEFTWARD FOR H";
        }
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl font-extrabold tracking-wide text-center w-full max-w-[1440px] mx-auto mb-12">
        Lesson 7.1 — Isolated Finger Drill (g and h Keys)
      </h1>
      ...
      <div className="w-full max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-[200px_1fr_420px] gap-10 items-start">
          ...
          <div className="bg-[#111827] border border-[#2b3245] border-l-[10px] border-l-purple-500 rounded-2xl px-10 py-8 shadow-2xl flex flex-col w-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-extrabold tracking-wide text-purple-400">
                Fingering Guide for G & H
              </h2>
            </div>
            <p className="text-md leading-relaxed text-gray-300 font-medium">
              Stretch your <span className="text-amber-400 font-bold">Left Index Finger</span> horizontally to the right from <span className="underline">F</span> to hit <span className="text-amber-400 font-bold">G</span>. Stretch your <span className="text-[#00E676] font-bold">Right Index Finger</span> horizontally to the left from <span className="underline">J</span> to hit <span className="text-[#00E676] font-bold">H</span>. Keep other hand anchors steady.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="bg-[#111827] border border-[#2b3245] rounded-3xl p-8 shadow-xl flex flex-col items-center text-center justify-center min-h-[180px]">
            ...
            <h3 className={`text-6xl font-black font-mono ${nextTargetChar === " " ? "text-gray-500" : nextTargetChar === "g" ? "text-amber-400" : "text-[#00E676]"}`}>
