...
// Hand territories for Shift tracking (Maintained for structural layout, though shift won't trigger)
const leftHandKeys = ["c"];
const rightHandKeys = [","];

// Generates practice streams containing ONLY 'c', ',', and spaces
    ...
    >
      ...
      <div className="w-full max-w-[1440px] mx-auto flex justify-between items-center mb-10 mt-8">
        ...
        <div className="flex items-center gap-8">
          {/* Custom Multi-Duration Selector Module with Added Height */}
      ...
      <h1 className="text-4xl font-extrabold tracking-wide text-center w-full max-w-[1440px] mx-auto mb-12">
        Lesson 6.1 Isolated Drill — Lowercase [c] and Comma [,]
      </h1>
      ...
      <div className="w-full max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-[200px_1fr_420px] gap-10 items-start">
          ...
          <div className="bg-[#111827] border border-[#2b3245] border-l-[10px] border-l-purple-500 rounded-2xl px-10 py-8 shadow-2xl flex flex-col w-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-extrabold tracking-wide text-purple-400">
                Pure Finger Isolation Drill
              </h2>
            </div>
            <p className="text-md leading-relaxed text-gray-300 font-medium">
              This drill contains <span className="text-purple-400 font-bold">only the C and Comma keys</span> to lock in muscle memory. Drop your left middle finger for <span className="text-amber-400 font-bold">c</span> and right middle finger for <span className="text-[#00E676] font-bold">,</span>.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="bg-[#111827] border border-[#2b3245] rounded-3xl p-8 shadow-xl flex flex-col items-center text-center justify-center min-h-[180px]">
            ...
            <h3 className={`text-6xl font-black font-mono ${nextTargetChar === " " ? "text-gray-500" : nextTargetChar === "c" ? "text-amber-400" : "text-[#00E676]"}`}>
          ...
          <div className="bg-[#0f172a] border border-[#2b3245] rounded-2xl p-5 shadow-inner flex flex-col min-h-[160px] justify-between">
            ...
            {!wrongKeyLog ? (
              ...
              <div className="flex justify-center items-center h-full pt-2">
                <span className="bg-red-950 text-red-400 border-2 border-red-600 px-4 py-2 text-center text-xs font-sans font-bold tracking-wide rounded-xl shadow-md transition-all">
                  {wrongKeyLog}
                </span>
              </div>
            )}
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 backdrop-blur-md p-4">
          <div className="bg-[#02040f] border-2 border-[#1b2236] rounded-[48px] p-16 flex flex-col items-center shadow-2xl text-center max-w-[640px] w-full mx-auto transition-all">
