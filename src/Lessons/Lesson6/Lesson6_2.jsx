...
// Generates 3-letter words with c, comma, mixed casing, and clean distribution
const generateWordParagraph = () => {
  const words = [
    "Cat", "Can", "Car", "Ice", "Cry", "Act", "Cut", "Cup", "Cap", "Cow",
    "cat", "can", "car", "ice", "cry", "act", "cut", "cup", "cap", "cow"
  ];
  const punctuation = ["", "", ",", "", ""];
    ...
    >
      ...
      <div className="w-full max-w-[1440px] mx-auto flex justify-between items-center mb-10 mt-8">
        ...
        <div className="flex items-center gap-8">
          {/* Multi-Duration Selector Module matched perfectly with Lesson 6.1 */}
      ...
      <h1 className="text-4xl font-extrabold tracking-wide text-center w-full max-w-[1440px] mx-auto mb-12">
        Lesson 6.2 — Short Mixed-Case Words (C and Comma)
      </h1>
          ...
          <div className="bg-[#111827] border border-[#2b3245] border-l-[10px] border-l-purple-500 rounded-2xl px-10 py-8 shadow-2xl flex flex-col w-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-extrabold tracking-wide text-purple-400">
                Shift Coordination Rules
              </h2>
            </div>
            <p className="text-md leading-relaxed text-gray-300 font-medium">
              Combine your speed on 3-letter structural words with <span className="text-purple-400 font-bold">Shift actions</span>. When a word starts with a capital <span className="text-amber-400 font-bold">C</span> (left hand), hold down your <span className="text-purple-400 font-bold">Right Shift key</span> with your right pinky finger.
            </p>
          </div>
