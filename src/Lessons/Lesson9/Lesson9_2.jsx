...
// Image Assets
import lessonKeyboard from "../../assets/lesson9.2.png"; // Assuming same keyboard image for now

// Comprehensive hand territories for all keys learned so far
const leftHandKeys = ["a", "s", "d", "f", "g", "c", "v", "w", "e", "r", "t", "A", "S", "D", "F", "G", "C", "V", "W", "E", "R", "T"];
const rightHandKeys = ["h", "j", "k", "l", ";", "'", "n", "m", "u", "i", "o", ",", ".", ":", "\"", "H", "J", "K", "L", "N", "M", "U", "I", "O"];

// Paragraphs featuring W, M, and full punctuation/capitalization (no b, p, q, x, y, z)
const paragraphLessons = [
  {
    id: 1,
    title: "Warm Up: W & M Flow",
    text: "Men and women want warm meals. He went down to the new town. \"Show me the snow,\" she said. We must swim in the warm river.",
    focus: "W, M, Shift + Quotes (\")",
  },
  {
    id: 2,
    title: "Punctuation & Dialog",
    text: "Mom warned him: \"Do not swim down there.\" He saw the wild water; it was cold. \"We need more time,\" the man cried.",
    focus: "W, M, Colon (:), Semicolon (;)",
  },
  {
    id: 3,
    title: "Full Integration Sprint",
    text: "How much snow will come tomorrow? We are sure the road is now clear. \"Come with me,\" William said. They went home.",
    focus: "Sustained Typing, Capital W, Question Mark (?)",
  }
];
  ...
  const handleKeyDown = (e) => {
    ...
    if (key.length === 1 || key === " ") {
      ...
      if (isCorrect) {
        ...
        if (
        ...
        } else if (expectedChar.toLowerCase() === "w") {
          displayInstruction = "STRETCH LEFT RING FINGER UP-LEFT FOR W";
        } else if (expectedChar.toLowerCase() === "m") {
          ...
          displayInstruction = "PRESS SEMICOLON WITH RIGHT PINKY";
        } else if (expectedChar === ",") {
