...
// Image Assets
import lessonKeyboard from "../../assets/lesson3.1.png";

const practicePairs = [
  "ru ", "ur ", "rr ", "uu ", "ru ", "ur ", "rr ", "uu ", "ru", "ur ", "rr ", "uu ",
];
...
export default function Lesson3_1() {
  ...
  const [timeLeft, setTimeLeft] = useState(10); // Keeps your custom 10s duration limit
  ...
  const handleKeyDown = (e) => {
    ...
    if (key.length === 1 || key === " ") {
      ...
      if (isCorrect) {
        ...
        // Custom validation checking if capitalization error occurred against a lowercase block value
        if (
          typedChar !== " " && 
          expectedChar !== " " && 
        ...
        <div className="flex flex-col gap-6 w-full">
          <div className="grid grid-cols-[1fr_minmax(400px,460px)] gap-6 items-center bg-[#111827] border border-[#2b3245] rounded-[32px] p-6 shadow-xl">
            ...
            <div className="bg-[#050816] p-3 rounded-2xl border border-[#222] flex flex-col items-center">
              ...
              />
              <span className="text-[11px] text-gray-500 mt-1 block tracking-wider font-mono">lesson3.1.png</span>
            </div>
          </div>
