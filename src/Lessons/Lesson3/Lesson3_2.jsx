...
const practiceWords = [
  "read ", "rule ", "user ", "raise ", "ideal ", "laser ", "leader ", "jellies ", "sailed ", "ruled ", "jailer ", "ruler ", "easilier ", "flier ", "jrui ", "slide ", "ride ", "field ", "sealer ",
];
...
export default function Lesson3_2() {
  ...
  const topKeys = ["A", "S", "D", "F", "J", "K", "L", ";", "E", "R", "U", "I"];
  const nextTargetChar = currentWord[typed.length]?.toUpperCase();

  return (
    /* FIXED: Swapped out "overflow-hidden" for "min-h-screen" 
       This allows the main window layer to scroll and successfully notify the navbar to go up! */
    <div
      tabIndex={0}
