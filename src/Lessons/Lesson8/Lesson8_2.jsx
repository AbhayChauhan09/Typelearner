...
// Image Assets
import lessonKeyboard from "../../assets/lesson8.2.png";

// Hand territories for strict cross-coordination Shift tracking
const leftHandKeys = ["v", "V"];
const rightHandKeys = ["n", "N"];

// Generates mixed-case practice streams containing ONLY 'v', 'V', 'n', 'N', and spaces
const generateWordParagraph = () => {
  const templates = [
    "v N v n V n n V v N v n V V n v N v n N v V n v N n v N v N v",
    "N N v v N v N v N v N v V n v N v N v N v N h h V v N v N v v N",
    ...
    "v N V n v V n n v v N N v n v N v N v n V n v V n N v V n n V",
...
export default function Lesson8_2() {
  ...
  const handleKeyDown = (e) => {
    ...
    if (key.length === 1 || key === " ") {
      ...
      if (isCorrect) {
        ...
        } else if (expectedChar === "v" || expectedChar === "V") {
          displayInstruction = "DROP LEFT INDEX FINGER DOWN-RIGHT FOR V";
        } else if (expectedChar === "n" || expectedChar === "N") {
  ...
  // Identifies if the absolute current target character demands a Shift key operation
  const dynamicShiftTarget = nextTargetChar !== "—" && nextTargetChar !== " " && nextTargetChar === nextTargetChar.toUpperCase();
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl font-extrabold tracking-wide text-center w-full max-w-[1440px] mx-auto mb-12">
        Lesson 8.2 — Mixed-Case Finger Drill (V and N Keys)
      </h1>
        ...
        <div className="flex flex-col gap-10 w-full">
          ...
          <div className="bg-[#111827] border border-[#2b3245] border-l-[10px] border-l-purple-500 rounded-2xl px-10 py-8 shadow-2xl flex flex-col w-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-extrabold tracking-wide text-purple-400">
                Advanced Coordination Checklist
              </h2>
            </div>
            <p className="text-md leading-relaxed text-gray-300 font-medium">
              Your hands must coordinate an inverted rhythm! When typing a capital <span className="text-purple-400 font-bold">N</span>, hold the <span className="underline">Left Shift</span> with your left pinky. When targeting a capital <span className="text-purple-400 font-bold">V</span>, anchor the <span className="underline">Right Shift</span> with your right pinky.
            </p>
          </div>
          ...
          <div className="w-full flex justify-between gap-6 bg-[#111827]/40 p-6 rounded-3xl border border-[#2b3245]/60">
            ...
            `}>
              ...
              <span className="text-[10px] opacity-75 mt-1 font-sans normal-case tracking-normal">(Hold for capital N targets)</span>
            </div>
            ...
            `}>
              ...
              <span className="text-[10px] opacity-75 mt-1 font-sans normal-case tracking-normal">(Hold for capital V targets)</span>
            </div>
          </div>
