...
// Image Assets
import lessonKeyboard from "../../assets/lesson8.3.png";

// Hand territories for advanced cross-coordination Shift tracking
const leftHandKeys = ["Shift", "a", "s", "d", "f", "e", "r", "t", "c", "g", "v"];
const rightHandKeys = ["/", "?", "j", "k", "l", ";", "u", "i", "o", ",", "h", "n", "'", "\""];
...
export default function Lesson8_3() {
  ...
  const handleKeyDown = (e) => {
    ...
    if (key.length === 1 || key === " ") {
      ...
      if (isCorrect) {
        ...
        if (expectedChar === "/") {
          displayInstruction = "TAP FORWARD SLASH CHIP WITH RIGHT PINKY";
        } else if (expectedChar === "?") {
          displayInstruction = "HOLD LEFT SHIFT (LEFT PINKY) + TAP SLASH KEY";
        }
  ...
  // Light up Left Shift indicator module strictly when a Question Mark (?) is required
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl font-extrabold tracking-wide text-center w-full max-w-[1440px] mx-auto mb-12">
        Lesson 8.3 — Slash [/] and Question Mark [?]
      </h1>
        ...
        <div className="flex flex-col gap-10 w-full">
          ...
          <div className="bg-[#111827] border border-[#2b3245] border-l-[10px] border-l-purple-500 rounded-2xl px-10 py-8 shadow-2xl flex flex-col w-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-extrabold tracking-wide text-purple-400">
                Fingering Guide for / and ?
              </h2>
            </div>
            <p className="text-md leading-relaxed text-gray-300 font-medium">
              Tap the key with your <span className="text-amber-400 font-bold">Right Pinky Finger</span>. For the question mark (<span className="text-purple-400 font-bold">?</span>), drop and hold your <span className="text-purple-400 font-bold">Left Pinky Finger</span> down on the Left Shift key before striking.
            </p>
          </div>
          ...
          <div className="w-full flex justify-between gap-6 bg-[#111827]/40 p-6 rounded-3xl border border-[#2b3245]/60">
            ...
            `}>
              ...
              <span className="text-[10px] opacity-75 mt-1 font-sans normal-case tracking-normal">(Hold left pinky for Question Mark target)</span>
            </div>
