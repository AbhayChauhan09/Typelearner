...
function App() {
  return (
    <BrowserRouter>
      {/* We use flex-col here so the Navbar stays at the top, 
        and the main content area fills the rest of the screen naturally.
      */}
      <div className="min-h-screen bg-[#0F1115] flex flex-col w-full overflow-x-hidden box-border">
        ...
        {/* This main wrapper is crucial. 
          flex-1 forces this box to take up all remaining vertical space under the navbar.
          w-full and box-border prevent horizontal scrolling issues.
        */}
